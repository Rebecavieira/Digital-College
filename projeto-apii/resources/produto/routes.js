...
app.patch(`${BASE_URL}/:id`, async (req, res) => {
    ...
    await database.execute(`
        UPDATE ${TABLE_NAME} SET
             ...
             id_marca = '${req.body.marca || jaExiste[0].marca}',
             id_categoria = '${req.body.categoria || jaExiste[0].categoria}',
...
//id_marca INT CONSTRAINT fk_ProdMarca FOREIGN KEY (id_marca) REFERENCES marca (id_marca)
//id_categoria INT CONSTRAINT fk_ProdCategoria FOREIGN KEY (id_categoria) REFERENCES category (id_categoria),
